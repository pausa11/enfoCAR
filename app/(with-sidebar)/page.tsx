    ...
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div id="quick-stats" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
          <div className="bg-black/60 backdrop-blur-xl rounded-2xl p-6 border border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 hover:scale-105 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            ...
            <p className="text-white/80">Gestiona todos tus vehículos en un solo lugar</p>
          </div>

          <div className="bg-black/60 backdrop-blur-xl rounded-2xl p-6 border border-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-300 hover:scale-105 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            <div className="flex items-center gap-4 mb-3">
            ...
            <p className="text-white/80">Mantén todo organizado y al día</p>
          </div>

          <div className="bg-black/60 backdrop-blur-xl rounded-2xl p-6 border border-blue-500/30 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 hover:scale-105 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <div className="flex items-center gap-4 mb-3">
        ...
        <div id="actions" className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500">
          ...
          <Link
            href="/app/assets"
            className="group bg-black/60 backdrop-blur-xl hover:bg-black/80 text-white font-bold py-4 px-8 rounded-xl border-2 border-cyan-400 hover:border-cyan-300 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/50 flex items-center gap-2"
          >
            Ver Mis Carros
        ...
        <div id="user-info" className="text-center mt-12 animate-in fade-in duration-700 delay-700">
          <p className="text-white/60 text-sm">
            Conectado como <span className="font-semibold text-white">{user.email}</span>
          </p>
        </div>
      </div>
    </div>
